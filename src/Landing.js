  ...
  return (
    <div className="landing">
      ...
      <section className="landing-different">
        ...
        <div className="landing-cards">
          <div className="landing-card">
            ...
            <p>Every bet, every payout, every market is on-chain. You can verify anything on the OKX Explorer anytime.</p>
          </div>
          <div className="landing-card">
            <h3>Winners get badges</h3>
            <p>Correct predictions earn you ERC-1155 NFT badges. Call 3 matches right and you unlock the World Cup Prophet badge.</p>
          </div>
          <div className="landing-card">
            <h3>Fair payouts</h3>
            <p>Winners split 95% of the pool proportionally to their stake. 5% goes to platform fees. Simple math, no surprises.</p>
          </div>
          <div className="landing-card">
            <h3>Real World Cup matches</h3>
            <p>Markets are created from live fixture data automatically. New matches go live as the tournament progresses.</p>
          </div>
        </div>
      </section>
      ...
      <section className="landing-cta">
        ...
        <button className="landing-launch-btn" onClick={() => navigate('/app')}>Start Predicting →</button>
        <p className="landing-cta-sub">No sign up. Just connect your OKX Wallet and go.</p>
      </section>
